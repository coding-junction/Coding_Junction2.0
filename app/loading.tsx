...
export default function Loading() {
  return (
    <div className="fixed inset-0 z-[100] flex h-screen w-full items-center justify-center bg-white dark:bg-black overflow-hidden transition-colors duration-300">
      ...
      <div className="relative flex flex-col items-center gap-10 z-10">
        ...
        <div className="relative flex items-center justify-center">
          ...
          {/* The CJ Logo — SVG Neon Trace Animation */}
          <svg
            viewBox="0 0 375 375"
          ...
          >
            {/* Dark fill layer — the solid logo shape */}
            <path
